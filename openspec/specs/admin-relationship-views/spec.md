# admin-relationship-views Specification

## Purpose

The super-admin console's dual presentation of cooperation data: a Prescribing view (grouped by doctor — who can they issue authorisations to) and an Employment view (grouped by clinic — who works there), over the same underlying relationship records.
