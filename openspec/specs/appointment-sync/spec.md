# appointment-sync Specification

## Purpose

Keeping the Dashboard's upcoming-authorisation-calls view and the Calendar in agreement in real time, guarding destructive appointment actions, and letting a doctor complete a call from the Dashboard.
