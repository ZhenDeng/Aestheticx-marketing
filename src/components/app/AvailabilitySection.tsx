...
// The former /app/availability page, folded into the bottom of the Calendar page (owner
// feedback 02/08). Rendered only after the calendar's own loading/error guards, so it
// assumes a loaded store and a signed-in identity.
export function AvailabilitySection({ me }: { me: Identity }) {
  ...
  return (
    <section className="mt-12 border-t border-line pt-8">
      ...
      {tab === "authorisation"
        ? (me.role === "doctor" ? <DoctorAvailability me={me} /> : <BookConsult me={me} />)
        : <TreatmentSchedule me={me} />}
    </section>
  );
}
  ...
  return (
    <>
      <div className="mt-6 rounded-card border border-line bg-card p-5">
        <h3 className="font-display text-lg text-ink">Your status</h3>
      ...
      <div className="mt-6 rounded-card border border-line bg-card p-5">
        <h3 className="font-display text-lg text-ink">Publish a window</h3>
      ...
      <h3 className="mt-8 font-display text-lg text-ink">Your windows</h3>
...
function TreatmentSchedule({ me }: { me: Identity }) {
  ...
  return (
    <>
      <div className="mt-6 rounded-card border border-line bg-card p-5">
        <h3 className="font-display text-lg text-ink">Weekly schedule</h3>
        <ul className="mt-3 flex flex-col gap-2">
          {config.days.map((d, i) => (
      ...
      <div className="mt-6 rounded-card border border-line bg-card p-5">
        <h3 className="font-display text-lg text-ink">Blocked times</h3>
        <div className="mt-3 flex flex-wrap items-end gap-3">
          <label className="text-sm text-ink-soft">Date
...
function ExternalCalendarCard({ ownerID }: { ownerID: string }) {
  ...
  return (
    <div className="mt-6 rounded-card border border-line bg-card p-5">
      <h3 className="font-display text-lg text-ink">External calendar</h3>
...
function BookConsult({ me }: { me: Identity }) {
  ...
  return (
    <div className="mt-6 flex flex-col gap-4">
      ...
      <div>
        <h3 className="font-display text-lg text-ink">Open slots</h3>
