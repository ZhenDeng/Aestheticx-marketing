...
// (textarea → mailto), so bullet characters stand in for the document's <ul> and the bold
// labels remain as "Label:" prefixes. Each document's closing sentence is appended once by
// aftercareBody instead of living in every template.
