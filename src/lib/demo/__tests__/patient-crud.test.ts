...
describe("deletePatient drops relational records", () => {
  it("removes the patient's authorisations, requests, and usages", () => {
    const state: DemoState = { ...emptyState(),
      patients: { p1: clinicPatient("p1") },
      authorisations: { a1: { id: "a1", requestID: "r", patientID: "p1", doctorID: "d", nurseID: "n", clinicID: "c1", medication: { name: "x", dosage: "1", category: "other", unit: "freeText", areas: [] }, repeatsRemaining: 5, expiresAt: NOW + 1, createdAt: NOW, invoiced: false } },
...
describe("mergePatients", () => {
  it("re-points notes + authorisations + usages, unions prescribers, drops the duplicate", () => {
    ...
    const state: DemoState = { ...emptyState(),
      ...
      authorisations: { a1: { id: "a1", requestID: "r", patientID: "remove", doctorID: "d", nurseID: "n", clinicID: "c1", medication: { name: "x", dosage: "1", category: "other", unit: "freeText", areas: [] }, repeatsRemaining: 5, expiresAt: NOW + 1, createdAt: NOW, invoiced: false } },
